#!/usr/bin/env python3
"""
MQTT Subscriber A Script
Subscribes to the "data/temperature" topic for temperature data
"""
...
MQTT_CLIENT_ID = "python_subscriber_A"
...
def main():
    ...
    try:
        ...
        print("\nStopping subscriber A...")
    except Exception as e:
        print(f"Error: {e}")
    finally:
        # Clean up
        client.disconnect()
        print("Subscriber A disconnected")
